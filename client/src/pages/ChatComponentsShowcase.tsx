      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            Alle 84 komponenter til Tekup AI v2 Chat System - komplet
            implementeret
          </p>
          <div className="flex justify-center gap-4">
            ...
            <Badge className="bg-purple-500 text-lg px-4 py-2">
              3 Data Viz 📊
            </Badge>
          </div>
        </div>
        ...
        >
            ...
            <Card className="p-8 bg-card border border-border">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li>
                      🆕 Interaktive charts (linje, søjle, cirkel diagrammer)
                    </li>
                    <li>
                      🆕 Avancerede data tabeller med sortering og filtrering
                    </li>
              ...
              <div className="mt-8 p-6 bg-white dark:bg-gray-800 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    1. <strong>Vælg en kategori</strong> fra tabs ovenfor
                  </p>
                  <p>
                    2. <strong>Se komponenter</strong> i aktion med demo data
                  </p>
                  <p>
                    3. <strong>Test funktionalitet</strong> - alle komponenter
                    er interaktive
                  </p>
                  <p>
                    4. <strong>Integrer i din app</strong> - kopier og tilpas
                    efter behov
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <MessageCard
                    message={{
                      ...
                      content:
                        "Ny lead fra Rengøring.nu. Kunde: Anne Sofie Feldberg, Email: annesofiefelberg@hotmail.com, Tlf: 40137619",
                ...
                <div className="space-y-2">
                  ...
                  <EmailCard
                    email={{
                      ...
                      preview:
                        "Hej, jeg vil gerne have et tilbud på rengøring af mit hjem. Tlf: 42709859",
                ...
                <div className="space-y-2">
                  ...
                  <NotificationCard
                    notification={{
                      ...
                      message:
                        "Tommy Callesen - Fast rengøring #7 er booket til 11. november kl. 08:00",
                    ...
                    onDismiss={() =>
                      setDialog({ type: "notification-details" })
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <TaskCard
                    task={{
                      ...
                      description:
                        "Send tilbud på privatrengøring til nadiasteiner94@gmail.com. Tlf: 42709859",
                ...
                <div className="space-y-2">
                  ...
                  <CalendarCard
                    event={{
                      ...
                      isOnline: false,
                      description:
                        "118 m² et-planshus - fast privatrengøring hver 14. dag",
                    }}
                ...
                <div className="space-y-2">
                  ...
                  <AnalyticsCard
                    ...
                    onViewDetails={() =>
                      setDialog({ type: "analytics-details" })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <QuickReplyCard
                    onSendReply={message =>
                      setDialog({ type: "message-reply", data: { message } })
                    }
                    onEditTemplate={id =>
                      setDialog({ type: "quick-reply-edit", data: { id } })
                    }
                  />
                </div>
              </div>
          ...
          <TabsContent value="interactive" className="space-y-6">
            <div className="grid gap-6">
              <div>
                <h2 className="text-2xl font-bold mb-4">
                  ⚡ Interactive Komponenter (5 nye)
                </h2>
                <p className="text-muted-foreground mb-6">
                  Approval flows, thinking indicators, sync status, phases og
                  action buttons
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <ApprovalCard
                    item={{
                      ...
                      title: "Fast rengøring #7 - Tommy Callesen",
                      description:
                        "118 m² privatrengøring hver 14. dag. Risdalsvej 7A, 8260 Viby J",
                      amount: "2.000 kr",
                      requestedBy: "Bassima",
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    2. Thinking Indicator - AI Processing
                  </h3>
                  <ThinkingIndicator
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    3. Sync Status - System Integration
                  </h3>
                  <SyncStatusCard
                    syncItems={[
                      {
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    4. Phase Tracker - Pipeline Stages
                  </h3>
                  <PhaseTracker
                    title="Lead Pipeline"
                    phases={[
                ...
                <div className="space-y-2 md:col-span-2">
                  <h3 className="font-semibold">
                    5. Action Buttons - Quick Actions
                  </h3>
          ...
          <TabsContent value="advanced-layouts" className="space-y-6">
            <div className="grid gap-6">
              <div>
                <h2 className="text-2xl font-bold mb-4">
                  🎨 Advanced Layouts & Controls (9 komponenter)
                </h2>
                <p className="text-muted-foreground mb-6">
                  Avancerede layouts, messaging, dokumenter, kontroller og
                  integrationer
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2 md:col-span-2">
                  <h3 className="font-semibold">
                    1. Split View Panel - Justerbare paneler
                  </h3>
                ...
                <div className="space-y-2 md:col-span-2">
                  <h3 className="font-semibold">
                    2. Message Thread - Trådede samtaler
                  </h3>
                      ...
                      messages={[
                        {
                          id: "1",
                          content:
                            "Hej, kan du hjælpe mig med at analysere vores lead data?",
                          author: {
                            name: "Bassima",
                            avatar: "",
                            role: "user",
                        ...
                        },
                        {
                          id: "2",
                          content:
                            "Ja, jeg kan se at vi har haft 231 leads i november. Lad mig analysere conversion raten.",
                          author: {
                            name: "Friday AI",
                            avatar: "",
                            role: "assistant",
                          ...
                          replies: [
                            {
                              id: "2.1",
                              content:
                                "Kan du specificere hvilke kilder du vil fokusere på?",
                              author: {
                                name: "Bassima",
                                avatar: "",
                                role: "user",
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    3. Document Viewer - PDF & dokument visning
                  </h3>
                  <DocumentViewer
                    document={{
                      id: "doc_001",
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    4. Chat Skeleton - Indlæsnings tilstande
                  </h3>
                  <div className="space-y-4">
                ...
                <div className="space-y-2 md:col-span-2">
                  <h3 className="font-semibold">
                    5. Message Toolbar - Formaterings værktøjer
                  </h3>
                  <MessageToolbar
                ...
                <div className="space-y-2 md:col-span-2">
                  <h3 className="font-semibold">
                    6. Floating Chat Window - Flydende chats
                  </h3>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    7. Notification System - Notifikationer
                  </h3>
                      ...
                      notifications={[
                        {
                          ...
                          title: "Ny booking bekræftet",
                          message:
                            "Tommy Callesen - Fast rengøring #7 er booket til i morgen kl. 08:00",
                          timestamp: new Date(Date.now() - 1000 * 60 * 5),
                          read: false,
                          category: "booking",
                          actionLabel: "Se kalender",
                        },
                        {
                          ...
                          message:
                            "Lead konverteringsrate er steget med 15% i dag",
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    8. Panel Size Variants - Responsive layouts
                  </h3>
                  <PanelSizeVariants
                    size="normal"
                    deviceType="auto"
                  ...
                  >
                    <div className="p-4 bg-card border border-border rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Dette indhold tilpasser sig til forskellige
                        skærmstørrelser og enheder.
                      </p>
                    </div>
                  </PanelSizeVariants>
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  <h3 className="font-semibold">
                    9. Integration Panel - Eksterne tjenester
                  </h3>
          ...
          <TabsContent value="chatgpt" className="space-y-6">
            <div className="grid gap-6">
              <div>
                <h2 className="text-2xl font-bold mb-4">
                  🤖 ChatGPT-Style (5 komponenter)
                </h2>
                <p className="text-muted-foreground mb-6">
                  Streaming messages, advanced composer, memory, sources og
                  tools - inspireret af ChatGPT
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2 md:col-span-2">
                  <h3 className="font-semibold">
                    1. Streaming Message - Token-by-Token Rendering
                  </h3>
...
Vil du have mere detaljeret analyse af en specifik periode eller lead-kategori?"
                ...
                <div className="space-y-2 md:col-span-2">
                  <h3 className="font-semibold">
                    2. Advanced Composer - Med Slash Commands & Uploads
                  </h3>
                  <AdvancedComposer
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    3. Memory Manager - Project Scopes & Context
                  </h3>
                  <MemoryManager
                    memories={[
                      {
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    4. Sources Panel - Citations & References
                  </h3>
                  <SourcesPanel
                    sources={[
                      {
                        ...
                        snippet:
                          "231 leads med Billy, Gmail og Calendar integration",
                        type: "database",
                        reliability: "high",
                      ...
                      },
                      {
                        ...
                        domain: "google.com",
                        snippet:
                          "152 bookings, gennemsnitlig 2-3 timer per job",
                        type: "web",
                        reliability: "high",
                ...
                <div className="space-y-2 md:col-span-2">
                  <h3 className="font-semibold">
                    5. Tools Panel - Search, Analysis & Code Execution
                  </h3>
                  <ToolsPanel
                    executions={[
                      {
                        ...
                        status: "completed",
                        input:
                          "Find latest pricing for cleaning services Aarhus",
                        output: { count: 15 },
                      ...
                      },
                      {
                        ...
                        steps: [
                          {
                            label: "Load data fra database",
                            status: "completed",
                          },
                          {
                            label: "Beregn conversion metrics",
                            status: "completed",
                          },
                          {
                            label: "Generer visualiseringer",
                            status: "completed",
                          },
                        ],
                      },
                    ...
                    onRunTool={(tool, input) =>
                      console.log("Run:", tool, input)
                    }
                  />
                </div>
              </div>
          ...
          <TabsContent value="data-visualization" className="space-y-6">
            <div className="grid gap-6">
              <div>
                <h2 className="text-2xl font-bold mb-4">
                  📊 Data Visualisering (3 komponenter)
                </h2>
                <p className="text-muted-foreground mb-6">
                  Metrics dashboards, charts og interaktive data tabeller
                </p>
              </div>
              ...
              <div className="grid gap-6">
                <div className="space-y-2">
                  <h3 className="font-semibold">
                    1. Metrics Dashboard - KPI Oversigt
                  </h3>
                  <MetricsDashboard
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-semibold">
                      3. Chart Component - Månedlig Omsætning
                    </h3>
                    <ChartComponent
                      title="Revenue Trend"
                    ...
                    columns={[
                      ...
                      },
                      {
                        ...
                        render: value => {
                          ...
                          return (
                            <span
                              className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${colors[value as keyof typeof colors] || "bg-gray-100 text-gray-800"}`}
                            >
                              {value}
                            </span>
                          );
          ...
          <TabsContent value="intelligence" className="space-y-6">
            <div className="grid gap-6">
              <div>
                <h2 className="text-2xl font-bold mb-4">
                  🧠 Intelligens & Analyse (10 komponenter)
                </h2>
                <p className="text-muted-foreground mb-6">
                  AI-drevne analyse værktøjer og data intelligence
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                    ...
                    insights={[
                      {
                        ...
                        description:
                          "Anne Sofie Feldberg har været kvalificeret i 3 dage uden opfølgning",
                        confidence: 85,
                        impact: "high",
                        category: "Sales",
                      },
                      {
                        ...
                        description:
                          "Ingen aktivitet fra Tommy Callesen i 45 dage",
                        confidence: 78,
                        impact: "medium",
                        category: "Retention",
                      },
                    ...
                    anomalies={[
                      {
                        ...
                        description:
                          "Lead konvertering er 15% under gennemsnittet denne uge",
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <SentimentAnalysisCard
                    sentiments={[
                      {
                        ...
                        source: "Email",
                        content:
                          "Tak for den hurtige og professionelle rengøring!",
                        sentiment: "positive",
                        confidence: 92,
                    ...
                    onViewDetails={sentiment =>
                      console.log("View sentiment:", sentiment)
                    }
                  />
                </div>
                    ...
                    recommendations={[
                      {
                        ...
                        description:
                          "45 kunder har ikke haft aktivitet i 30+ dage",
                        impact: "3stars",
                        effort: "medium",
                        category: "Retention",
                        confidence: 88,
                      },
                      {
                        ...
                        description:
                          "Data viser potentiale for 15% højere margin på store opgaver",
                        impact: "4stars",
                        effort: "high",
                        category: "Pricing",
                        confidence: 76,
                    ...
                    patterns={[
                      {
                        ...
                        type: "seasonal",
                        description:
                          "Booking aktivitet topper hver onsdag og torsdag",
                        confidence: 89,
                        strength: 78,
                        frequency: "Weekly",
                        impact: "medium",
                      ...
                      },
                      {
                        ...
                        type: "trend",
                        description:
                          "Konverteringsrate falder med 8% når priser > 2000 kr",
                        confidence: 82,
                        strength: 65,
                        frequency: "Monthly",
                        impact: "high",
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <RiskAssessmentCard
                    risks={[
                      {
                        ...
                        description:
                          "15 fakturaer på 45.000 kr udestående over 30 dage",
                      ...
                      },
                      {
                        ...
                        description:
                          "Booking rate overstiger kapacitet med 25%",
                    ...
                    onStartMitigation={id =>
                      console.log("Start mitigation:", id)
                    }
                    ...
                    suggestions={[
                      {
                        ...
                        answer:
                          'Brug "Opret lead" knappen eller skriv "@lead" efterfulgt af kundens information.',
                        category: "Leads",
                        confidence: 95,
                      },
                      {
                        ...
                        answer:
                          'Vælg en kvalificeret lead og klik "Send tilbud" eller brug "/tilbud" kommandoen.',
                        category: "Offers",
                        confidence: 88,
                      },
                    ]}
