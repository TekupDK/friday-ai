...
export function CalendarEventCardDemo() {
  const [stage, setStage] = useState<
    "initial" | "analyzing" | "suggesting" | "confirmed" | "created"
  >("initial");
  ...
  const playDemo = async () => {
    ...
    setMessages(prev => [
      ...prev,
      {
        ...
        type: "ai",
        content:
          "Jeg læser først tråden for at forstå konteksten, og derefter laver jeg et test kalender event.",
      },
    ]);
    ...
    setMessages(prev => [
      ...prev,
      {
        ...
        type: "ai",
        content:
          "Perfekt - d. 12. februar er helt ledig! Nu opretter jeg et TEST kalender event som eksempel:",
      },
    ]);
  };
  ...
  const handleCreateEvent = async () => {
    ...
    setMessages(prev => [
      ...prev,
      {
        ...
        type: "ai",
        content:
          "✓ Event oprettet! Kalenderen er nu opdateret med Matilde's flytterengøring.",
      },
    ]);
  };
  ...
  const handleSkip = () => {
    setMessages(prev => [
      ...prev,
      {
        ...
        type: "ai",
        content:
          "Ok, springer over. Lad mig vide hvis du vil oprette eventet senere.",
      },
    ]);
  };
        ...
        <div className="grid grid-cols-1 gap-6">
            ...
            <div className="w-1/4 border-r bg-muted/30 flex flex-col">
              ...
              <ScrollArea className="flex-1 p-2 min-h-[550px]">
                <div className="space-y-2">
                  ...
                  {(stage === "analyzing" || stage === "confirmed") &&
                    messages.length > 0 && (
          ...
          <div className="p-4 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800">
            ...
            <ol className="text-xs space-y-1 text-muted-foreground ml-6 list-decimal">
              <li>
                <strong>Initial:</strong> User asks to create calendar example
              </li>
              <li>
                <strong>Analyzing:</strong> AI reads email thread and plans
                response
              </li>
              <li>
                <strong>Suggesting:</strong> AI checks calendar availability and
                shows event card
              </li>
              <li>
                <strong>Confirmed:</strong> User clicks "Create event" button
              </li>
              <li>
                <strong>Created:</strong> Event successfully created with
                success state
              </li>
            </ol>
          </div>
