...
import { 
  Bot, Send, Sparkles, TrendingUp, CheckCircle2, 
  Mail, Clock, DollarSign, User, Zap, MessageSquare
} from "lucide-react";
...
const chatHistory: Message[] = [
  { 
    id: '1', 
    type: 'ai', 
    content: '👋 God morgen! Du har 3 nye emails der kræver handling. Skal jeg hjælpe dig med at prioritere dem?',
    timestamp: '09:00'
  },
  { 
    id: '2', 
    ...
    <div className="relative min-h-[750px] rounded-2xl overflow-hidden">
      ...
      <div className="relative flex h-[750px]">
        ...
        <div className="w-[45%] border-r border-white/30 backdrop-blur-xl bg-white/50 flex flex-col">
          ...
          <div className="p-6 border-b border-white/30">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Friday AI Assistant</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-semibold text-gray-800">AI Prioritized Actions</span>
                </div>
              </div>
            </div>
          </ScrollArea>
        ...
        <div className="flex-1 p-6">
          <div className="mb-6">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Smart Suggestions</h3>
            <p className="text-sm text-gray-600">AI-recommended actions for your inbox</p>
          </div>
              ...
              {suggestions.map((suggestion, idx) => {
                ...
                return (
                  <div
                    ...
                    style={{ animation: `fadeIn 0.5s ease-out ${idx * 0.15}s both` }}
                  >
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <div>
                                <div className="font-semibold text-sm text-gray-900">{suggestion.from}</div>
                                <div className="text-xs text-gray-600">{suggestion.subject}</div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className={cn(
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <div className="text-xs font-semibold text-gray-600 mb-1">AI RECOMMENDATION</div>
                        ...
                        {suggestion.estimatedValue && (
                          <div className="flex items-center gap-4 mb-4 p-3 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100">
                            ...
                            <div>
                              <div className="text-xs text-green-600 font-semibold">ESTIMATED VALUE</div>
                              <div className="text-lg font-bold text-green-700">
                                {suggestion.estimatedValue.toLocaleString('da-DK')} kr
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {suggestion.quickActions.map((action, i) => (
                            ...
                            >
                              {action === 'Send Tilbud' && <Send className="w-3.5 h-3.5 mr-1.5" />}
                              {action === 'Opret Lead' && <User className="w-3.5 h-3.5 mr-1.5" />}
                              {action === 'Book Møde' && <Clock className="w-3.5 h-3.5 mr-1.5" />}
                              {action === 'Mark Paid' && <CheckCircle2 className="w-3.5 h-3.5 mr-1.5" />}
                              {action}
                            </Button>
                          ))}
                        </div>
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            {[
              { icon: Mail, label: 'Processed', value: '12', color: 'from-blue-500 to-cyan-500' },
              { icon: Zap, label: 'Auto-replied', value: '8', color: 'from-purple-500 to-pink-500' },
              { icon: CheckCircle2, label: 'Completed', value: '5', color: 'from-green-500 to-emerald-500' }
            ].map((stat, i) => {
              ...
              return (
                <div key={i} className="relative group">
                  ...
                  <div className="relative p-4 rounded-2xl bg-white/80 backdrop-blur-md border border-white/50 shadow-lg hover:shadow-xl transition-all">
                    <Icon className={cn("w-5 h-5 mb-2 bg-gradient-to-r bg-clip-text text-transparent", stat.color)} />
