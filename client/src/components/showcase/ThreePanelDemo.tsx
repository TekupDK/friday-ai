      ...
      <ResizablePanelGroup direction="horizontal">
          ...
          <div className="h-full bg-blue-50 dark:bg-blue-950/20 border-r p-4">
            ...
            <div className="space-y-2">
              ...
              <div className="text-center space-y-3 py-8">
                ...
                <div className="space-y-2">
                  {['📅 Tjek kalender', '💰 Vis fakturaer', '📧 Analyser emails', '❓ Hjælp'].map((item, i) => (
                    <div key={i} className="p-2 bg-white dark:bg-gray-900 rounded-lg border text-xs hover:bg-muted transition-colors">
                      {item}
                    </div>
                  ))}
                </div>
        ...
        <ResizablePanel defaultSize={60} minSize={40}>
          <div className="h-full bg-background border-r p-4">
            ...
            <div className="space-y-2">
              {[
                { from: 'kunde@firma.dk', subject: 'Tilbud på projekt', unread: true },
                { from: 'partner@email.dk', subject: 'Meeting i morgen', unread: true },
                { from: 'info@service.dk', subject: 'Faktura betalt', unread: false },
              ].map((email, i) => (
                <div key={i} className={`p-3 border rounded-lg hover:bg-muted/50 transition-colors ${email.unread ? 'bg-blue-50/30 dark:bg-blue-950/20' : ''}`}>
            ...
            <div className="space-y-3">
              <div className="p-3 bg-white dark:bg-gray-900 rounded-lg border">
                ...
                <div className="space-y-1">
                  <div className="text-xs text-muted-foreground">• Opret lead</div>
                  <div className="text-xs text-muted-foreground">• Book møde</div>
                  <div className="text-xs text-muted-foreground">• Ny faktura</div>
                </div>
              </div>
              ...
              <div className="p-3 bg-white dark:bg-gray-900 rounded-lg border">
                ...
                <div className="space-y-1">
                  <div className="text-xs text-muted-foreground">• Lead #123</div>
                  <div className="text-xs text-muted-foreground">• Faktura #456</div>
                </div>
              </div>
            </div>
          </div>
