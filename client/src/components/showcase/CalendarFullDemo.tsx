...
const demoEvents: CalendarEvent[] = [
  ...
  },
  {
    ...
    title: "Forfaldsdato: Faktura #4567",
    type: "invoice",
  },
  {
    id: "5",
    date: addDays(new Date(), 6).toISOString(),
    title: "Demo: AI Email Assistant",
    time: "13:30",
    type: "meeting",
    attendees: 3,
  },
                    ...
                    {dayEvents.slice(0, 3).map(ev => (
                      <Tooltip key={ev.id}>
                        <TooltipTrigger asChild>
                          <div
                            className={cn(
                              "flex items-center gap-2 px-2 py-1 rounded-md border text-xs truncate",
                        ...
                        <TooltipContent>
                          <div className="text-xs space-y-1">
                            <div className="font-medium flex items-center gap-1">
                              {typeStyles[ev.type].icon} {ev.title}
                            </div>
                            {ev.time && (
