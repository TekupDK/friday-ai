...
const COMMANDS: Command[] = [
  {
    name: "/search",
    description: "Søg i emails og dokumenter",
    icon: Search,
    shortcut: "⌘K",
    category: "search",
  },
  {
    name: "/create-lead",
    description: "Opret nyt lead",
    icon: Users,
    category: "create",
  },
  {
    name: "/send-quote",
    description: "Send tilbud til kunde",
    icon: FileText,
    category: "create",
  },
  {
    name: "/book-meeting",
    description: "Book møde i kalender",
    icon: Calendar,
    category: "create",
  },
  {
    name: "/help",
    description: "Vis hjælp og dokumentation",
    icon: Zap,
    category: "action",
  },
];
        ...
        {filteredCommands.map((cmd, idx) => {
          ...
          return (
            ...
            >
              ...
              {cmd.shortcut && (
                <kbd className="px-2 py-1 text-xs bg-background/20 rounded">
                  {cmd.shortcut}
                </kbd>
              )}
            </button>
