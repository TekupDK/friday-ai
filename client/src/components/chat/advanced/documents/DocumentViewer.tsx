...
export interface DocumentViewerProps extends React.HTMLAttributes<HTMLDivElement> {
  document?: {
    id: string
    title: string
    type: 'pdf' | 'image' | 'text' | 'spreadsheet' | 'presentation' | 'video' | 'audio' | 'archive' | 'unknown'
    url: string
    size?: string
    lastModified?: Date
    pages?: number
...
export function DocumentViewer({
  ...
  const typeColor = document?.type ? documentTypeColors[document.type] : 'text-gray-500'
  ...
  if (error) {
    return (
      <div className={cn(
        ...
        <h3 className="text-lg font-semibold text-destructive mb-2">Fejl ved indlæsning</h3>
  ...
  if (!document && !content) {
    return (
      <div className={cn(
        ...
        <h3 className="text-lg font-semibold text-muted-foreground mb-2">Intet dokument valgt</h3>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              ...
              {document?.lastModified && (
                <>
                  <span>•</span>
                  <span>{document.lastModified.toLocaleDateString('da-DK')}</span>
                </>
              )}
        ...
        {document?.type === 'image' && document.url ? (
          ...
          <div className="h-full flex items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Dokument type ikke understøttet</h3>
