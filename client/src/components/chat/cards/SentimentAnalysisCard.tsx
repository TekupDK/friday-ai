            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">
                  {Math.round(
                    (overallSentiment.positive / overallSentiment.total) * 100
                  )}
                  %
                </div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-gray-600">
                  {Math.round(
                    (overallSentiment.neutral / overallSentiment.total) * 100
                  )}
                  %
                </div>
                <div className="text-xs text-muted-foreground flex items-center justify-center gap-1">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-red-600">
                  {Math.round(
                    (overallSentiment.negative / overallSentiment.total) * 100
                  )}
                  %
                </div>
                <div className="text-xs text-muted-foreground flex items-center justify-center gap-1">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                Ingen sentiment data tilgængelig
              </p>
            </div>
          ) : (
            <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge
                            className={cn(
                              "text-xs",
                              getSentimentBadgeColor(sentiment.sentiment)
                            )}
                          >
