  ...
  return (
    <div 
      className={cn(
        ...
        status === 'completed' && "bg-green-50/80 dark:bg-green-950/30 border-green-100 dark:border-green-900/50",
        status === 'failed' && "bg-red-50/80 dark:bg-red-950/30 border-red-100 dark:border-red-900/50",
        className
      )}
    >
      {/* Emoji icon */}
