...
import { Slash, Command, HelpCircle, Calendar, Mail, FileText, Search, Settings, Zap } from "lucide-react";
    ...
    <Card className="border-l-4 border-l-purple-500">
      <div className="p-4 space-y-4">
        ...
        <div className="space-y-2">
          <label className="text-xs font-medium text-muted-foreground">Skriv en kommando:</label>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-medium text-sm">{selectedCommand.command}</span>
                  <Badge className={getCategoryColor(selectedCommand.category)}>
                    {getCategoryLabel(selectedCommand.category)}
                  </Badge>
                </div>
                <p className="text-xs text-muted-foreground mb-2">{selectedCommand.description}</p>
                
                {selectedCommand.example && (
                  <div className="mb-2">
                    <p className="text-xs font-medium text-purple-700 dark:text-purple-400">Eksempel:</p>
                    <p className="text-xs text-purple-600 dark:text-purple-400">{selectedCommand.example}</p>
                  </div>
                )}
                
                {/* Parameter Input */}
                <div className="space-y-1">
                  <label className="text-xs font-medium">Parametre (valgfrit):</label>
                  <input
                    value={commandParams}
        ...
        {/* Quick Commands */}
        <div className="space-y-2">
          <label className="text-xs font-medium text-muted-foreground">Hurtige kommandoer:</label>
        ...
        <div className="p-3 rounded-lg bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800">
          <div className="flex items-start gap-2">
            ...
            <div className="text-xs text-purple-700 dark:text-purple-400">
              <p className="font-semibold mb-1">Hvordan bruges slash commands:</p>
