...
import { Settings, User, Bell, Shield, Palette, Globe, Database, Zap, Save, RotateCcw } from "lucide-react";
...
export function SettingsPanel({ 
  ...
  const currentSection = allSections.find(section => section.id === activeSection) || allSections[0];
    ...
    <Card className="border-l-4 border-l-gray-500">
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Indstillinger og konfiguration</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Badge className="bg-gray-500">{allSections.length} sektioner</Badge>
        ...
        <div className="space-y-2">
          <label className="text-xs font-medium text-muted-foreground">Sektioner:</label>
          ...
          <div className="space-y-3">
            <div className="p-3 rounded-lg bg-gray-50 dark:bg-gray-950/20 border border-gray-200 dark:border-gray-800">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h5 className="font-semibold text-sm">{currentSection.title}</h5>
              </div>
        ...
        <div className="grid grid-cols-3 gap-2 text-xs">
          ...
          <div className="p-2 rounded-lg bg-orange-50 dark:bg-orange-950/20 text-center">
            ...
            <p className="text-orange-600 dark:text-orange-400">Indstillinger</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 pt-2 border-t">
          <Button onClick={handleSave} className="bg-linear-to-r from-gray-600 to-slate-600">
