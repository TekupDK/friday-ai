...
const ChatInputField = forwardRef<HTMLInputElement, ChatInputFieldProps>(({
  ...
  return (
    <div data-testid="friday-chat-input-wrapper" className="bg-muted/50 rounded-xl px-2 py-2 flex items-center gap-1.5">
      {/* Left side icons */}
      <div data-testid="friday-input-left-icons" className="flex items-center gap-1">
        {leftIcons}
      </div>
      ...
      {/* Right side icons */}
      <div data-testid="friday-input-right-icons" className="flex items-center gap-1">
        {rightIcons}
      </div>
    </div>
  );
