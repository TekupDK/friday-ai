      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between gap-2 mb-2">
              <div className="flex items-center gap-2 min-w-0 flex-1">
                ...
                {messageCount > 1 && (
                  <Badge
                    variant="outline"
                    className="shrink-0 bg-blue-50 text-blue-700 border-blue-200 text-xs"
                  >
                ...
                <span
                  className={`font-semibold text-base leading-relaxed shrink-0 ${
                    latestMessage.unread
                      ? "text-foreground"
                      : "text-foreground/80"
                  }`}
                ...
                <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                  <EmailQuickActions
                    ...
                    onSnooze={(threadId, until) =>
                      console.log("Snooze thread:", threadId, until)
                    }
                    onMarkAsRead={() => console.log("Mark read:", thread.id)}
                    onMarkAsUnread={() =>
                      console.log("Mark unread:", thread.id)
                    }
                  />
                </div>
              </div>
            ...
            <h3
              className={`text-sm leading-relaxed mb-2 truncate ${
                latestMessage.unread
