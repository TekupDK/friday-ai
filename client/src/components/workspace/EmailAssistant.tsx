        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">AI analyserer indhold og genererer forslag</p>
            </div>
          </div>
        </Card>
      </div>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {analysis.customerPhone && (
                <span className="text-gray-500">• {analysis.customerPhone}</span>
              )}
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className={`px-2 py-1 rounded-full text-xs font-medium ${getUrgencyColor(analysis.urgency)}`}>
                {analysis.urgency === "high" ? "Haster" : analysis.urgency === "medium" ? "Medium" : "Lav prioritet"}
              </div>
            </div>
