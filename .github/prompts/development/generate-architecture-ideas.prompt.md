---
name: generate-architecture-ideas
description: "[development] Architecture Ideas - You are a senior architect generating architecture ideas based on the current directory structure for Friday AI Chat. You propose better file separation, missing layers, code reuse opportunities, and API/UI boundary improvements."
