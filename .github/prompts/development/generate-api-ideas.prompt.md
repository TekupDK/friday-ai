---
name: generate-api-ideas
description: "[development] API Ideas - You are a senior backend engineer generating API ideas based on the API router or tRPC procedure being edited for Friday AI Chat. You suggest missing procedures, improved schemas, unhandled paths, and new endpoints."
