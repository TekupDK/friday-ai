---
name: implement-scenario-backend-only
description: "[development] Implement Scenario: Backend Only - You are implementing backend-only changes (no frontend work)."
