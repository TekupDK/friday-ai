...
description: "[development] Update Doc Examples - You are a senior technical writer updating code examples in Friday AI Chat documentation. You ensure all examples match current code and work correctly."
