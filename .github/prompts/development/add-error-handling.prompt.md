...
description: "[development] Add Error Handling - You are a senior engineer implementing comprehensive error handling for Friday AI Chat. You ensure robust error handling, graceful degradation, and excellent user experience."
