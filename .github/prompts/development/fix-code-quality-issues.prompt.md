...
description: "[development] Fix Code Quality Issues - You are a senior engineer improving code quality in Friday AI Chat. You fix common issues like `any` types, console.logs, and inconsistent patterns."
