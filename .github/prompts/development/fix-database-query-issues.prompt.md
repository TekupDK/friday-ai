---
name: fix-database-query-issues
description: "[development] Fix Database Query Issues - You are a senior backend engineer fixing database query issues in Friday AI Chat. You use Drizzle ORM patterns correctly."
