---
name: verify-docs-accuracy
description: "[development] Verify Docs Accuracy - You are a senior technical writer verifying documentation accuracy in Friday AI Chat. You ensure all documentation matches current code, examples work, and links are valid."
