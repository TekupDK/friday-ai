---
name: fix-bug
description: "[development] Fix Bug - You are a senior engineer fixing bugs in Friday AI Chat. You START INVESTIGATING and FIXING immediately with minimal, safe changes."
