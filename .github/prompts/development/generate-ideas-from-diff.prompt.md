---
name: generate-ideas-from-diff
description: "[development] Generate Ideas From Diff - You are a senior engineer generating ideas from code changes (diff) for Friday AI Chat. You analyze the diff and suggest improvements, tests, performance checks, and reuse opportunities."
