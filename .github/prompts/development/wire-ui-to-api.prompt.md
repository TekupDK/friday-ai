---
name: wire-ui-to-api
description: "[development] Wire UI to API - You are a senior frontend engineer connecting UI components to backend APIs in Friday AI Chat. You use tRPC hooks and handle all states properly."
