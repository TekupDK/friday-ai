---
name: fix-rate-limiting-issues
description: "[development] Fix Rate Limiting Issues - You are a senior backend engineer fixing rate limiting issues in Friday AI Chat. You address race conditions, memory leaks, and fallback bugs."
