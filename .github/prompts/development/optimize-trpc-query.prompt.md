---
name: optimize-trpc-query
description: "[development] Optimize tRPC Query - You are a senior fullstack engineer optimizing tRPC queries for performance in Friday AI Chat. You identify bottlenecks and apply targeted optimizations."
