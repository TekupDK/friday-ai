...
description: "[core] Get Session Status - You are a senior engineer providing real-time status of the current chat session for Friday AI Chat. You quickly assess what's been done, what's in progress, and what's next."
