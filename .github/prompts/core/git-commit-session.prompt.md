...
description: "[core] Git Commit Session - You are a senior engineer creating a git commit with only the changes made during this chat session. You START COMMITTING immediately after identifying session files."
