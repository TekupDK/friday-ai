...
description: "[core] Get Project Status - You are a senior engineer providing comprehensive project status for Friday AI Chat. You aggregate status from all systems, features, and development plans into a single overview."
