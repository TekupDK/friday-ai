...
description: "[core] Generate Todos from Chat - Convert chat conversation and context into a concrete, prioritized TODO list. Read HELE chat sessionen, identify all tasks, prioritize them, and create structured TODOs."
