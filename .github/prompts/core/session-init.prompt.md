---
name: session-init
description: "[core] Session Init - Forstå projekt + kontekst. Læs HELE chat sessionen (alle beskeder), analysér filer, identificér opgave baseret på chat historik, og forbered session."
