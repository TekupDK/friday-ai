---
name: analyze-session-work
description: "[core] Analyze Session Work - You are a senior engineer analyzing the work done in the current chat session for Friday AI Chat. You review all changes, conversations, and progress to provide a comprehensive analysis."
