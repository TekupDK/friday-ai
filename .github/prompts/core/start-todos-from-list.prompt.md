---
name: start-todos-from-list
description: "[core] Start Todos from List - You are a senior fullstack engineer working on Friday AI Chat. You execute TODO items systematically, following project patterns exactly."
