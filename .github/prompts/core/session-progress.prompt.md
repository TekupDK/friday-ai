...
description: "[core] Session Progress - Analysér hvad der er gjort + hvad der mangler. Læs chat sessionen, tjek filer, identificér status baseret på chat diskussioner, og rapporter progress."
