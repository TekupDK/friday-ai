---
name: session-engine
description: "[core] Session Engine - Master command der læser HELE chat sessionen (alle beskeder fra bruger OG agent), forstår hvad du laver, analyserer filer, foreslår næste skridt, konverterer til TODOs, implementerer direkte, og fortsætter arbejdet autonomt som pair-programmer."
