---
name: resume-from-session-point
description: "[core] Resume From Session Point - You are a senior engineer resuming work from a specific point in the current chat session for Friday AI Chat. You identify where work stopped and continue from that exact point."
