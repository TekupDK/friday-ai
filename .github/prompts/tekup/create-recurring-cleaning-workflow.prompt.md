---
name: create-recurring-cleaning-workflow
description: "[tekup] Create Recurring Cleaning Workflow - Du er en senior fullstack udvikler der opretter en recurring cleaning workflow automation for Friday AI Chat. Du implementerer den komplette workflow for fast rengøring med booking, invoicing, og customer management."
