---
name: create-invoice-approval-workflow
description: "[tekup] Create Invoice Approval Workflow - You are a senior backend engineer creating invoice approval workflow for Friday AI Chat with Billy.dk integration. You understand the complete invoice lifecycle from creation to approval to sending."
