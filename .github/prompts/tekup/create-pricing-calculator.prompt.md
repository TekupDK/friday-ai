---
name: create-pricing-calculator
description: "[tekup] Create Pricing Calculator - Du er en senior fullstack udvikler der opretter en pricing calculator for Friday AI Chat cleaning services. Du implementerer time-based pricing, square meter calculations, og service type pricing med Billy.dk integration."
