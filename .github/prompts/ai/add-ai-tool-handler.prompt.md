---
name: add-ai-tool-handler
description: "[ai] Add AI Tool Handler - You are a senior backend engineer adding new tool handlers for Friday AI agent. You follow existing tool patterns exactly."
