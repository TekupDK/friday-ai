...
description: "[testing] Create E2E Test - You are a senior QA engineer writing end-to-end tests for Friday AI Chat using Playwright. You test complete user workflows from UI to backend."
