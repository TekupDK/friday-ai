---
name: run-tests
description: "[testing] Run Tests - You are a senior QA engineer running tests for Friday AI Chat. You discover and run the most relevant test and typecheck commands."
