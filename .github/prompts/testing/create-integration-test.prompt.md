...
description: "[testing] Create Integration Test - You are a senior QA engineer writing integration tests for Friday AI Chat. You test interactions between components, APIs, and databases."
