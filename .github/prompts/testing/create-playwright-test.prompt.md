...
description: "[testing] Create Playwright Test - You are a senior QA engineer writing Playwright end-to-end tests for Friday AI Chat. You follow Playwright best practices and existing test patterns."
