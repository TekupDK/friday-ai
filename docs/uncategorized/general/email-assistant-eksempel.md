...
🤖 EMAIL ANALYSIS ENGINE OUTPUT:
{
  ...
  urgency: "medium",
  estimatedPrice: 1800,
  estimatedHours: "3-4 timer",
  specialRequirements: ["Førstegangsrengøring", "85 m²"],
  sourceDetection: {
    source: "direct",
    confidence: 0.9
  }
...
Jeg jeg gerne høre mere om dine specifikke ønsker, så vi kan skræddersy opgaven bedst mul
...
Tak for din interesse i rengøring af din lejlighed i Aarhus C.

For at kunne give dig det mest præcise tilbud, har jeg brug for lidt mere information:

1. **Adressen på lejligheden** (for præcis planlægning)
2. **Antal etager** (lejlighed på stueplan eller flere plan)
3. **Tilstand af køkken og bad** (standard eller grundig rengøring)
4. **Ønsker du vinduespudsning?** (inde/ude eller kun inde)
5. **Er der særlige områder med ekstra fokus?**

Når jeg har disse informationer, kan jeg give dig et nøjagtigt prisoverslag og tids estimat.

Jeg normalt tilbyde hovedrengøring i Aarhus fra 450 kr./time afhængigt af opgavens omfang.

Jeg jeg høre fra dig, så vi kan finde den bedste løsning til dig!
...
Tak for din henvendelse vedrørende rengøring i Aarhus.
...
Hvilket tidspunkt kunne passe dig bedst? Jeg kan sende dig nogle konkrete datoer.
...
Jeg jeg gerne ringe dig op for en uforpligtende snak om dine behov og give dig et præcist tilbud?

Med venlig hilsen,
[Dit Navn]
Rendetalje.dk - Din lokale rengøringspartner i Aarhus"
...
│ ├─────────────────────────────┤ │
│ │ 💡 AI Forslag:               │ │
│ │ [Prisoverslag 85%] [Info 75%]│ │
│ │ [Booking 70%] [Aarhus 90%]   │ │
│ ├─────────────────────────────┤ │
│ │ ✏️ Email Kladde:             │ │
│ │ [Kære Jens Hansen, Tak for...]│ │
│ │ [Insert Reply] [Send Email]  │ │
│ └─────────────────────────────┘ │
├─────────────────────────────────┤
│ Hej,                             │
│ Jeg skal bruge hovedrengøring...│
│ [Fuld email content...]         │
├─────────────────────────────────┤
...
**Systemet transformerer en standard email henvendelse til en professional business kommunikation på under 2 minutter!** 🚀

**Vil I have mig til at starte development server og se det i aktion med rigtige emails?** 🤔
