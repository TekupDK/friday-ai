...
1. Setup Docker/Python service
1. Create scraping endpoints
1. Test basic web scraping
1. Integrate with leads API
...
USER_AGENT = "FridayAI-Bot/1.0 (+<https://friday-ai.com/bo>t)"
