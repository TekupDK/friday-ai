...
{
  threadIds: Array(101).fill("thread");
} // Zod validation error

// ❌ Invalid request (item too long)
{
  threadIds: ["a".repeat(101)];
} // Zod validation error
```
...
- [Codebase Health Analysis](../../status-reports/reviews/CODEBASE_HEALTH_ANALYSIS_2025-01-28.md)
- [Engineering TODOs](../../status-reports/feature-status/ENGINEERING_TODOS_2025-01-28.md)
