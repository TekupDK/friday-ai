...
```typescript
include: [".cursor/**/*.test.ts", ".cursor/**/*.spec.ts"];
```
...
- [Hook System Documentation](../../accessibility-audits/README.md)
- [Hook-Command Integration Guide](../../features/cursor-integration/HOOK_COMMAND_INTEGRATION_GUIDE.md)
- [Cursor Setup Guide](./CURSOR_SETUP_GUIDE.md)
- [Testing Implementation Summary](../../status-reports/feature-status/TESTING_IMPLEMENTATION_SUMMARY.md)
