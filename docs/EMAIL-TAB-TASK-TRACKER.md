# EmailTab Task Tracker

## 🎯 Current Sprint: UI Polish & Advanced Features
...
- **[ETUI-006]** Snippet Sanitization (HTML/entities)
- **[ETUI-007]** Sidebar Compact Rows
- **[ETUI-008]** Small Count Badges
- **[ETUI-009]** Flat Email Cards (border-bottom rows)
- **[ETUI-010]** Flat Section Headers
...
- **[ETUI-016]** Command Palette (Cmd+K)
- **[ETUI-017]** Enhanced Email Composer Modal
- **[ETUI-018]** Email Preview Modal Improvements
- **[ETUI-019]** Bulk Action Sheets
- **[ETUI-020]** Toast Notifications with Undo
...
- [EMAIL-TAB-UI-IMPROVEMENTS.md](./EMAIL-TAB-UI-IMPROVEMENTS.md) - Detailed technical documentation
- [3-PANEL-EMAIL-INTEGRATION.md](./3-PANEL-EMAIL-INTEGRATION.md) - Layout integration guide
- [SHORTWAVE_CONTEXT_FEATURE.md](../SHORTWAVE_CONTEXT_FEATURE.md) - Design inspiration
