...
1. ✅ **Chat TRPC endpoints** - COMPLETE

1. ✅ **Promptfoo LLM quality** - COMPLETE

#### Medium Priority (Quality)

1. ⏸️ **useFridayChat hook** - 90% complete

1. ⏸️ **E2E Playwright tests** - 95% complete

#### Low Priority (Nice-to-have)

1. ⏸️ Component unit tests
1. ⏸️ Integration tests (action flows)
...
1. **B (New Feature)** - 2-4 hours, user value

1. **A (Hook Tests)** - 30 minutes, completeness
