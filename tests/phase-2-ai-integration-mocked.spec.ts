...
test.describe("Phase 2: Tools Integration (Mocked)", () => {
  ...
  test("should handle calendar suggestion with mocked response", async ({ page }) => {
    await page.goto("http://localhost:3000/");
    await page.waitForSelector('[data-testid="friday-ai-panel"]');
  ...
  test("should handle invoice suggestion with mocked response", async ({ page }) => {
    await page.goto("http://localhost:3000/");
    await page.waitForSelector('[data-testid="friday-ai-panel"]');
  ...
  test("should handle leads suggestion with mocked response", async ({ page }) => {
    await page.goto("http://localhost:3000/");
    await page.waitForSelector('[data-testid="friday-ai-panel"]');
...
test.describe("Phase 2: Integration (Mocked)", () => {
  ...
  test("should handle complete flow: optimistic + context + tools", async ({ page }) => {
  ...
  test("should handle all suggestions with full integration", async ({ page }) => {
    await page.goto("http://localhost:3000/");
    await page.waitForSelector('[data-testid="friday-ai-panel"]');
