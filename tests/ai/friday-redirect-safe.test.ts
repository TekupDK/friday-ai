...
test.describe('🤖 Friday AI - Redirect Safe Tests', () => {
  test('🎯 Friday AI Basic Functionality', async ({ page }) => {
    ...
    for (const selector of fridaySelectors) {
      try {
        ...
        if (await element.isVisible({ timeout: 2000 })) {
          console.log(`✅ Found Friday AI component with selector: ${selector}`);
          fridayFound = true;
    ...
    if (!fridayFound) {
      console.log('ℹ️ Friday AI components not found - testing basic page functionality');
      ...
      console.log(`🔘 Buttons: ${buttons}, 📝 Inputs: ${inputs}, 📄 Textareas: ${textAreas}`);
