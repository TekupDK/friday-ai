...
test.describe('🤖 AI Docs - Authenticated Flow', () => {
  ...
  test('should show AI generation buttons when authenticated', async ({ page }) => {
    ...
    console.log(`✓ New Document button: ${hasNewDoc ? '✅ Found' : '❌ Not found'}`);
  ...
  test('should display AI-generated doc with proper formatting', async ({ page }) => {
    ...
    // Check for AI tags
    const aiTags = await page.locator('[class*="badge"]:has-text("ai"), [class*="tag"]:has-text("ai")').count();
