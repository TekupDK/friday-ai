...
test.describe("Phase 1: Mocked AI Tests (Fast)", () => {
  ...
  test("should send message and receive mocked AI response quickly", async ({
    page,
  }) => {
    await page.goto("http://localhost:3000/");
  ...
  test("should handle multiple messages quickly with mocking", async ({
    page,
  }) => {
    await page.goto("http://localhost:3000/");
    await page.waitForSelector('[data-testid="friday-ai-panel"]');
  ...
  test("should load conversation quickly with mocked data", async ({
    page,
  }) => {
    await page.goto("http://localhost:3000/");
...
test.describe("Phase 1: Performance with Mocking", () => {
  ...
  test("should maintain UI responsiveness during message sending", async ({
    page,
  }) => {
    await page.goto("http://localhost:3000/");
    await page.waitForSelector('[data-testid="friday-ai-panel"]');
