...
import { createInvoice } from "../billing/billy";
...
export async function createSubscription(
  ...
  if (options?.referralCode) {
    const { validateReferralCode, calculateReferralDiscount } = await import("../../modules/crm/referral-helpers");
    const { applyReferralCode } = await import("../../modules/crm/referral-actions");
