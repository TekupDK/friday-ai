...
async function testEmbeddings() {
  ...
  console.log(`Similarity 1-2: ${similarity12.toFixed(4)} (should be HIGH - same company)`);
  console.log();
  console.log(`Text 3: "${text3}"`);
  console.log(`Similarity 1-3: ${similarity13.toFixed(4)} (should be LOW - different topic)\n`);

  // Test 3: Lead similarity
  console.log('Test 3: Lead deduplication test');
  const lead1 = 'Name: John Doe\nEmail: john@acme.com\nCompany: ACME Corp\nMessage: Interested in your product';
  const lead2 = 'Name: John Doe\nEmail: john.doe@acme.com\nCompany: ACME Corporation\nMessage: Want to buy your service';
  const lead3 = 'Name: Jane Smith\nEmail: jane@xyz.com\nCompany: XYZ Inc\nMessage: Need pricing information';
  ...
  console.log(`Similarity: ${leadSim12.toFixed(4)} (should be HIGH - likely duplicate)`);
  console.log();
  console.log(`Lead 3: Jane Smith @ XYZ`);
  console.log(`Similarity: ${leadSim13.toFixed(4)} (should be LOW - different person)\n`);
