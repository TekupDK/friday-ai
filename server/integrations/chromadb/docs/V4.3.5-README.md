...
2. Læser AI-parsed frequency fra event description
3. Validerer & korrigerer hvis AI er mere præcis
...
interface CustomerValueMetrics {
  ...
  isActive: boolean;
  isRecurring: boolean;
  recurringFrequency: 'weekly' | 'biweekly' | 'triweekly' | 'monthly' | 'irregular' | null;
