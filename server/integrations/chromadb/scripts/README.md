...
1. **Email Threads** (Gmail)
1. **Billy Customer Database**
...
1. **Tune threshold** (after collecting data)
...
1. **Update threshold** if recommended
...
1. **Re-tune periodically** (e.g., quarterly)
...
1. **Monitor false positives** in production logs
1. **Collect more data** as your business grows
1. **A/B test** if unsure (e.g., 0.80 vs 0.85)
1. **Document changes** in git commits
