...
console.log(
  `❓ Other: ${gmailLeads.length - realLeads.length - spamLeads.length}`
);
...
console.log(`\n💡 PROBLEM IDENTIFIED:`);
console.log(
  `   The Gmail collection included ${spamLeads.length} irrelevant emails!`
);
console.log(
  `   We should only use the ${realLeads.length} real customer leads.`
);
