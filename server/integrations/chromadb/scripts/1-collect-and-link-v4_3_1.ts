/**
 * V4.3.1 Script 1: Collect & Link (Targeted)
 * 
 * Collects ONLY emails sent TO known lead-receiving addresses:
 * - info@rendetalje.dk
 * - system@leadpoint.dk
 * - kontakt@leadmail.no
 * - sp@adhelp.dk
 ...
 * 
 * Output: raw-leads-v4_3_1.json (much cleaner, ~300-400 leads)
 * 
...
async function main() {
  try {
    ...
    const outputPath = resolve(
      process.cwd(),
      'server/integrations/chromadb/test-data/raw-leads-v4_3_1.json'
    );
    ...
    console.log('\n📌 Note: V4.3.1 uses targeted Gmail search for cleaner data\n');
