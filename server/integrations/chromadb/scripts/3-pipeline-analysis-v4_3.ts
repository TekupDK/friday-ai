...
const jsonPath = resolve(
  process.cwd(),
  'server/integrations/chromadb/test-data/v4_3-analysis-report.json'
);
...
mdLines.push('# V4.3 Pipeline Analysis Report');
mdLines.push('');
...
console.log('');
console.log('✅ V4.3 Pipeline Complete!');
console.log('\n💾 Output Files:');
console.log('   • complete-leads-v4.3.json');
console.log('   • v4_3-analysis-report.json');
console.log('   • v4_3-analysis-report.md');
console.log('');
