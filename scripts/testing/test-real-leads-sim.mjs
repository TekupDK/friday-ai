...
const realisticLeads = [
  {
    ...
    status: "new",
    notes:
      "Ønsker tilbud på flytterengøring i 3-værelses lejlighed i Aarhus C. Fraflytning d. 15. december. Kræver syn for tilbud.",
  ...
  },
  {
    ...
    status: "contacted",
    notes:
      "Kontor på 200m2 i Aarhus N. Ønsker ugentlig rengøring. Har ringet tilbage og aftalt møde til kl. 14:00 i morgen.",
  ...
  },
  {
    ...
    status: "qualified",
    notes:
      "Privat rengøring hver 14. dag i villa på 180m2. Har 2 børn og hund. Ønsker start fra december. Budget: 800-1000 kr/gang.",
  ...
  },
  {
    ...
    status: "new",
    notes:
      "Vinduespudsning på rækkehus. 12 vinduer. Ønsker udført inden jul. Svar på email foretrækkes.",
  ...
  },
  {
    ...
    status: "interested",
    notes:
      "Efterspørger dybderengøring af lejlighed efter renovation. Ca. 90m2. Kan bookes når som helst de næste 2 uger. Meget interesseret.",
    created_at: new Date("2024-11-09"),
  },
];

console.log(
  `📊 Testing with ${realisticLeads.length} realistic lead scenarios\n`
);
