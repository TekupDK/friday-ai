...
const testStorybook = async () => {
  ...
  try {
    ...
    await page.goto('http://localhost:6006/iframe.html?id=apple-ui-applebutton--primary&viewMode=story')
    ...
    console.log('Theme switching works:', JSON.stringify(lightStyles) !== JSON.stringify(darkStyles))
