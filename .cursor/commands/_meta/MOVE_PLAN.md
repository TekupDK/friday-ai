# Commands Move Plan - FASE 2

**Dato:** 2025-11-16  
**Status:** 🔄 KLAR TIL FLYTTNING
...
- `laes-chat-samtale.md` (dansk)
- `analyser-chat-kontekst.md` (dansk)
- `brug-chat-informationer.md` (dansk)
- `ekstraher-chat-data.md` (dansk)
- `sammenfat-chat-samtale.md` (dansk)
- `opdater-chat-summary.md` (dansk)
- `konverter-chat-til-todos.md` (dansk)
- `identificer-chat-patterns.md` (dansk)
- `forsta-chat-kontekst.md` (dansk)
- `ekstraher-chat-requirements.md` (dansk)
- `valider-chat-informationer.md` (dansk)
- `opret-chat-dokumentation.md` (dansk)
- `sammenlign-chat-samtaler.md` (dansk)
- `analyser-chat-sessioner.md` (dansk)
- `laes-chat-fra-database.md` (dansk)
