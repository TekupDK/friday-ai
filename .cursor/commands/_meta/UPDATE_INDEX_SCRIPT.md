...
- `continue-*.md` → `core/continue-*.md`
- `forsaet-*.md` → `core/forsaet-*.md`
- `resume-*.md` → `core/resume-*.md`
- `*todo*.md` → `core/*todo*.md`
- `commit-*.md` → `core/commit-*.md`
- `git-commit-*.md` → `core/git-commit-*.md`
- `sprint-*.md` → `core/sprint-*.md`
- `create-sprint-*.md` → `core/create-sprint-*.md`
- `opdater-sprint.md` → `core/opdater-sprint.md`
- `task-*.md` → `core/task-*.md`
- `hvad-nu.md` → `core/hvad-nu.md`
- `identificer-manglende.md` → `core/identificer-manglende.md`
- `fortael-naermere.md` → `core/fortael-naermere.md`
- `afslut-session.md` → `core/afslut-session.md`
...
- `improve-*.md` → `development/improve-*.md`
- `fix-*.md` → `development/fix-*.md`
- `add-*.md` → `development/add-*.md`
- `setup-*.md` → `development/setup-*.md`
- `*review*.md` → `development/*review*.md`
- `*audit*.md` → `development/*audit*.md`
- `generate-ideas-*.md` → `development/generate-ideas-*.md`
- `analyze-*.md` → `development/analyze-*.md`
- `uddyb-*.md` → `development/uddyb-*.md`
...
- `generate-test-*.md` → `testing/generate-test-*.md`
- `run-tests.md` → `testing/run-tests.md`
- `udvikle-test.md` → `testing/udvikle-test.md`
...
- `reproduce-bug.md` → `debugging/reproduce-bug.md`
...
- `optimize-ai-*.md` → `ai/optimize-ai-*.md`
...
- `optimize-billy-*.md` → `tekup/optimize-billy-*.md`
- `test-friday-*.md` → `tekup/test-friday-*.md`
- `debug-friday-*.md` → `tekup/debug-friday-*.md`
...
- `convert-chat-*.md` → `chat/convert-chat-*.md`
