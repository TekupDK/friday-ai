...
Quick reference guide to the most commonly used commands in Friday AI Chat.
...
- `maintain-context.md` - Maintain context
...
- `sync-docs-with-code.md` - Sync docs with code
- `find-outdated-docs.md` - Find outdated docs
- `update-doc-examples.md` - Update examples
...
4. `wire-ui-to-api.md` - Connect UI to API
...
4. `performance-audit.md` - Performance check
...
- `COMMANDS_INDEX.md` - Full index
- `CHANGELOG.md` - Recent changes

## 💡 Tips

- Use `continue-session.md` to maintain context
- Use `session-summary.md` at end of session
