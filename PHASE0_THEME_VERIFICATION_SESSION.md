...
2. **Story ID Format** skal matche Storybook exports præcist
3. **Story Load Validation** kræver både HTTP response og DOM content checks
4. **Selectors** skal være brede nok til at håndtere varierende markup
5. **About:blank Navigation** kan forårsage interruption errors
